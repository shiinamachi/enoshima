...
assert_contains "$dock" 'id: uiFixtureStateProcess'
assert_contains "$dock" '"--follow=name"'
assert_contains "$dock" 'splitMarker: "\n"'
assert_contains "$dock" 'onRead: data => root.loadUiFixtureState(data)'
